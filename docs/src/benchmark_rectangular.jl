...
m, n = 10000, 1000 #size of A: m x n

#Names of solvers:
#names = [:Juliainv, :Krylov_cgls, :PLSSRRand, :PLSSR, :RandomizedBlockKaczmarz] #:Krylov_minres,
names = [:Juliainv, :PLSSRRand, :PLSSR, :RandomizedBlockKaczmarz]
...
for i=1:N
  ...
  for name in names
    ...
    @time eval(name)(la_stop, r = 80, hist = 80)
