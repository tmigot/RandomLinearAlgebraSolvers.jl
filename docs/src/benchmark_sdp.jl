...
# A is generated randomly such that
...
n = 500 #size of A: m x n

#Names of solvers:
names = [:Juliainv, :Krylov_cg, :Krylov_cg_lanczos, :Krylov_diom, :PLSSRRand, :RandomizedBlockKaczmarz, :RandomizedNewton, :RandomizedCD2]
